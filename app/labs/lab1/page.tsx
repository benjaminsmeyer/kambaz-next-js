  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe for scrambled eggs:
        <ol id="wd-your-favorite-recipe">
          <li>Whisk eggs with a splash of milk or water.</li>
          <li>Season with salt and pepper.</li>
          <li>Heat a non-stick skillet over medium heat and add butter.</li>
          <li>Pour in the egg mixture.</li>
          <li>
            Let it sit for a few seconds, then gently stir with a spatula.
          </li>
          <li>
            Continue to cook, stirring occasionally, until eggs are softly set.
          </li>
      ...
      <h4>GitHub Link</h4>
      Please&nbsp;
      <a href="https://github.com/benjaminsmeyer/kambaz-next-js" id="wd-github">
        click here
      </a>
